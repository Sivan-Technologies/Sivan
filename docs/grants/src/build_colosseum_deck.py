...
streams = [
    ("1.25%", "Off ramp", "USDC to naira. Returned live by our public fee endpoint.", GREEN),
...
text(s, M + Inches(0.34), Inches(5.62), CW - Inches(0.7), Inches(0.4),
     [("Remittance into Nigeria costs 5 to 10 percent. We clear it at 1.25 and keep a margin.",
       13, False, INK)])
foot(s, N)
