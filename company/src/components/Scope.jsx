import { MapPin, Scale, ArrowRight } from 'lucide-react'
          ...
          <Reveal>
            <div>
              ...
              <p className="lead" style={{ fontSize: '1.07rem' }}>
                Sivan currently operates in Nigeria, helping content creators and freelancers
                connect with the specific jobs they offer and coordinate delivery through WhatsApp.
              </p>

              <a href="#contact" className="btn btn-primary" style={{ marginTop: 30 }}>
              ...
              <div className="card" style={{ padding: 32, display: 'flex', gap: 20, alignItems: 'flex-start' }}>
                ...
                <div>
                  ...
                  <p style={{ color: 'var(--muted)', fontSize: '0.95rem', marginTop: 8 }}>
                    WhatsApp-based service orchestration that connects creators and freelancers
                    with jobs no app download, no setup required.
                  </p>
                </div>
              </div>
            </Reveal>
            <Reveal delay={160}>
              <div className="card" style={{ padding: 32, display: 'flex', gap: 20, alignItems: 'flex-start' }}>
                ...
                <div>
                  ...
                  <p style={{ color: 'var(--muted)', fontSize: '0.95rem', marginTop: 8 }}>
                    Both parties can submit context when a dispute arises. Structured delivery
